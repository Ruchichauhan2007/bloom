...
$uniqueSurveyId =   $_POST['uniqueSurveyId'];
	...
	{	
		try
		{
			...
			$accessInfo = array();
			$accessInfo[0]->roleName = "PROVIDER";
			$accessInfo[0]->accessLevel = "EDIT";
			
			$accessInfo[1]->roleName = "PATIENT";
			$accessInfo[1]->accessLevel = "READ_ONLY";
			
			$accessInfo[2]->roleName = "FAMILY";
			$accessInfo[2]->accessLevel = "NONE";
			
			$metaInfo->accessList = $accessInfo;
			$surveyPage->metaInfo = $metaInfo;*/
