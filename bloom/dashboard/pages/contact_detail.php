...
{
$("#Dzip,#zip").keydown(function(event)
{ 	
...
var addresssChecked="<?php echo $addressInfo[0]->{preferred}?>";
var phoneChecked="<?php echo $phoneInfo[0]->{preferred}?>"; 
var emailChecked='<?php echo $emailaddressinfo[0]->{preferred}?>';
if(addresssChecked)
{
...
if(phoneChecked)
{
$("#DeliveryPhone").attr('checked','checked');
}	
if(emailChecked)
{
$("#DeliveryEmail").attr('checked','checked');
}	
...
if( phone =="")
{
	$("#DeliveryPhone").attr("disabled","disabled");
}
var email = $("#email").val();
if( email =="")
{
	$("#DeliveryEmail").attr("disabled","disabled");
}

$("#address1,#address2,#city,#zip,#state").on('change keyup',function()
{
...
{
	$("#DeliveryPhone").removeAttr("disabled");
});

$("#email").on('change keyup',function()
{
	$("#DeliveryEmail").removeAttr("disabled");
});
</script>
...
<div>
<div class="col-lg-12">
<div class="col-md-6 FormLeft1" id="billingDiv">
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <input  name="address1" id="address1" maxlength="50"  placeholder="Address Line 1" class="form-control input-md" value="<?php echo $addressInfo[0]->{addressLine1}?>" type="text" />
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <input  name="address2" id="address2" maxlength="50"  placeholder="Address Line 2" class="form-control input-md" value="<?php echo $addressInfo[0]->{addressLine2}?>" type="text" />
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input  name="city" id="city" maxlength="50" placeholder="City / State" class="form-control input-md" value="<?php echo $addressInfo[0]->{city}?>" type="text">
  </div>
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <input  name="zip" id="zip" maxlength="5"  placeholder="Zip" class="form-control input-md" value="<?php echo $addressInfo[0]->{postalCode}?>" type="text">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <input style="width: 48%;" id="phone" name="phone" maxlength="15"  placeholder="Phone" class="form-control input-md" value="<?php echo $phoneInfo[0]->{phoneNumber};?>" type="text">
  </div>
</div>
<div class="form-group spanHide">
  <label class="col-md-4 control-label" for="textinput">E-mail<span style="color:#b30f2a;">*</span></label>  
  <div class="col-md-8">
  <input  style="width: 48%;" maxlength="50"  id="email" name="email" placeholder="E-mail" class="form-control input-md" value="<?php echo $emailaddressinfo[0]->{emailAddress};?>" type="text">
  </div>
</div>
...
<div class="rightFormContact">
<h1>Delivery Information: <span   style="font-size: 13px; margin-left: 14px;"><span  style="margin-right:10px;"><input id="DeliveryAddress" type="checkbox"  name="DeliveryAddress" value="DeliveryAddress"/></span>Same as billing information</span></h1>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Address<span style="color:#b30f2a;">*</span></label>  
  <div class="col-md-8">
  <input  name="Daddress1" id="Daddress1" maxlength="50" placeholder="Address Line 1" value="<?php echo $addressInfo[1]->{addressLine1};?>" class="form-control input-md" type="text">
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput"></label>  
  <div class="col-md-8">
  <input  name="Daddress2" id="Daddress2" maxlength="50" placeholder="Address Line 2" value="<?php echo $addressInfo[1]->{addressLine2};?>" class="form-control input-md" type="text">
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label"  for="textinput">City / State<span style="color:#b30f2a;">*</span></label>  
  <div class="col-md-4">
  <input name="Dcity" id="Dcity" maxlength="50" value="<?php echo $addressInfo[1]->{city};?>" placeholder="City / State" class="form-control input-md" type="text">
  </div>
  <div class="col-md-4">
    <span class="custom-dropdown custom-dropdown--white" style="width:116px;">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Zip<span style="color:#b30f2a;">*</span></label>  
  <div class="col-md-8">
  <input name="Dzip" id="Dzip" maxlength="5" placeholder="Zip" value="<?php echo $addressInfo[1]->{postalCode};?>" class="form-control input-md" type="text">
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Phone<span style="color:#b30f2a;">*</span></label>  
  <div class="col-md-8">
  <input style="width: 48%; float: left;" maxlength="15" id="Dphone" name="Dphone"  placeholder="Phone" value="<?php echo $phoneInfo[1]->{phoneNumber};?>" class="form-control input-md" type="text"><span   style="margin-left: 10px; float: left; margin-top: 4px;"><span style="margin-right:10px;"><input  id="DeliveryPhone" type="checkbox"  name="DeliveryPhone" value="DeliveryPhone"/></span>Same as billing</span>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">E-mail<span style="color:#b30f2a;">*</span></label>  
  <div class="col-md-8">
  <input style="width: 48%; float: left;" maxlength="50"id="Demail" name="Demail"  value="<?php //echo $emailaddressinfo[1]->{emailAddress};?>" placeholder="E-mail" class="form-control input-md" type="text"><span   style="margin-left: 10px; float: left; margin-top: 4px;"><span style="margin-right:10px;"><input   id="DeliveryEmail"  type="checkbox" name="DeliveryEmail" value="DeliveryEmail"/></span>Same as billing</span>
  </div>
</div>-->
	  ...
	  <div class="form-group" >
        <div class="pull-right1 pull-right1-responcive" style="margin-top: 25px;margin-right: 22px;">
          <div class="col-sm-6" style="padding-left:0px;">
            <input type="button" value="<?php echo constantAppResource::$COMMON_BUTTON_CANCEL;?>" id="pageCancel" class="but_cancel_bg" data="postFormAndHideAlert('<?php $_SERVER['SERVER_NAME']?>/gladstone/portal/bloom/dashboard/pages/portal_addPatient.php?edit=true&patientId=<?php echo $patientId; ?>&type=EDIT','','menu-content',event,'myModal')"  onClick="postFormAndHideAlert('<?php $_SERVER['SERVER_NAME']?>/gladstone/portal/bloom/dashboard/pages/portal_addPatient.php?edit=true&patientId=<?php echo $patientId; ?>&type=EDIT','','menu-content',event,'myModal')"/>
          </div>
...
var phone = localStorage["phone"];
 ...
 $("#Daddress1").val(Daddress1);
var Daddress2 = localStorage["Daddress2"];
 $("#Daddress2").val(Daddress2);
...
var Dzip = localStorage["Dzip"];
 $("#Dzip").val(Dzip);
var Demail = localStorage["Demail"];
 $("#Demail").val(Demail);
var Dphone = localStorage["Dphone"];
 $("#Dphone").val(Dphone);
 
var DeliveryAddress = localStorage["DeliveryAddress"];
var DeliveryPhone = localStorage["DeliveryPhone"];
var DeliveryEmail = localStorage["DeliveryEmail"];
if(DeliveryAddress == "true" || DeliveryAddress == true )
{
 $("#DeliveryAddress").attr('checked','checked');
}
else{
...
if(DeliveryPhone == "true" || DeliveryPhone == true )
{
 $("#DeliveryPhone").attr('checked',true);
}
else{
 $("#DeliveryPhone").removeAttr('checked');
}
if(DeliveryEmail == "true" || DeliveryEmail == true )
{
 $("#DeliveryEmail").attr('checked','checked');
}
else{
 $("#DeliveryEmail").removeAttr('checked');

}
console.log("add:"+DeliveryAddress+"DeliveryPhone:"+DeliveryPhone+"DeliveryEmail:"+DeliveryEmail);
