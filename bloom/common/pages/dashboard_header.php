...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container-fluid">
		...
		<!--	<li><a href="#">Education</a></li>-->
				...
				{	?>
				<!--<li id="menu-content-container" class="Enter Biometrics"><a href="#" onClick="openPageWithAjax('../../vitals/pages/vitals_manual_entry.php','','menu-content',event,this)"><img src="/gladstone/portal/bloom/common/images/heart_img.png" alt=""></a></li>-->
							<li id="menu-content-container" onClick="filterMenu(this);" class="<?php echo constantAppResource::$COMMON_MENU_TEXT_TRACK_BIOMETRICES;?>">
				<a href="#" id="headerBiomatric"><img  alt="" title="Track Biometrics">Biometrics</a>
				...
				{
				?>
				<!--<li id="menu-content-container"  class="<?php // echo constantAppResource::$COMMON_MENU_TEXT_MESSAGES;?>"  onClick="filterMenu(this)"><a href="#" onClick="openPageWithAjax('../../messages/pages/messages.html','','menu-content',event,this)">Messages</a></li>-->
			   	<li  onClick="filterMenu(this)"><a href="#">Patient</a></li>
			   
				<li>
				 <?php if($hideFilter != TRUE)
		{
			/*?>
        <span id="patImage" style="display:none;"><img src="/gladstone/portal/bloom/common/images/patient.png" /></span>&nbsp;&nbsp; <span id="patientName" class="header-select" style="display:none;"></span>
       <span id="patsImages"><img src="/gladstone/portal/bloom/common/images/patients.png" /></span>&nbsp;&nbsp;<select id="patients"  class="header-select">
							<option value="My Patients"><?php echo constantAppResource::$PORTAL_DASHBOARD_TEXT_MY_PATIENTS;?></option>
							<option  selected="selected" value="All Patients"><?php echo constantAppResource::$PORTAL_DASHBOARD_TEXT_ALL_PATIENTS;?></option>
							<option value="Select a Patient"><?php echo constantAppResource::$PORTAL_DASHBOARD_TEXT_SELECT_PATIENTS;?></option>
                            <option value="selectedPatient" style="display:none;"></option>
						</select>
       <?php */}
		else
		{
		?>
         <input type="hidden" name="" id="patients" value="Patient" />
        <?php
		}?>
				</li>
          </ul>
